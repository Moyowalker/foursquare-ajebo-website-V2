  ...
  const contactInfo = [
    {
      icon: "📍",
      title: "Address",
      details: ["Foursquare Ajebo Camp & Retreat Center", "Ajebo Hill, Ogun State", "Nigeria"],
      color: "from-blue-400 to-purple-600"
    },
    {
      icon: "📞",
      title: "Phone Numbers",
      details: ["+234 803 123 4567", "+234 807 890 1234", "WhatsApp: +234 811 222 3333"],
      color: "from-green-400 to-teal-600"
    },
    {
      icon: "📧",
      title: "Email Addresses",
      details: ["info@foursquareajebo.org", "bookings@foursquareajebo.org", "events@foursquareajebo.org"],
      color: "from-yellow-400 to-orange-600"
    },
    {
      icon: "🌐",
      title: "Social Media",
      details: ["@FoursquareAjebo", "facebook.com/ajebocamp", "instagram.com/ajebo_camp"],
