...
import { ArrowLeft, Bed, Wifi, Car, Coffee, Shield, Users, Phone, MapPin } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Accommodation Types */}
          <div className="mb-16">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Accommodation Options</h2>
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        ...
                        <p className="text-blue-600 font-medium">{accommodation.capacity}</p>
                      </div>
                      <div className="text-right">
                        <div className="text-2xl font-bold text-green-600 mb-1">{accommodation.price}</div>
