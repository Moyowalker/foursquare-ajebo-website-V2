...
export default function AnthonyEtiolojaPage() {
  return (
      ...
      <section className="bg-white border-b border-slate-200">
        <div className="container mx-auto px-4 py-10">
          <div className="flex flex-col gap-4">
            ...
            <h1 className="text-4xl font-semibold text-slate-900">Mr Anthony Etioloja</h1>
            <p className="text-lg text-slate-600">Finance Manager</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 grid gap-10 lg:grid-cols-[1fr_1.1fr]">
          <div className="relative h-96 rounded-3xl overflow-hidden border border-slate-200 bg-white">
            <Image
              src="/images/leadership/executives/anthony-etioloja.jpg"
              alt="Mr Anthony Etioloja"
              fill
          ...
          <div className="space-y-6">
            <div className="rounded-3xl border border-slate-200 bg-white p-6">
              ...
              <p className="mt-3 text-slate-600">
                Mr Anthony Etioloja manages financial stewardship for the camp, ensuring responsible
                budgeting, transparent reporting, and operational accountability.
              </p>
            </div>
            <div className="rounded-3xl border border-slate-200 bg-white p-6">
              ...
              <ul className="mt-4 space-y-2 text-slate-600">
                ...
                <li>• Resource allocation for camp operations</li>
                <li>• Compliance and financial documentation</li>
              </ul>
            </div>
            <Link
              href="/contact"
